...
public class UserNotificationBase : ComponentBase, IUserNotificationService
{
    ...
    public async Task<bool> ShowMessageBoxAsync(string title, string message,
        ...
        await DialogService.ShowMessageBoxAsync(title, message, yesText ?? "OK", noText, cancelText);
    ...
    public async Task<bool> ShowDeleteMessageBoxAsync(string title, string message) =>
        await DialogService.ShowDeleteMessageBoxAsync(title, message);
    ...
    public async Task ShowErrorMessageBoxAsync(string title, string message) =>
        await DialogService.ShowErrorMessageBoxAsync(title, message);
    ...
    {
        await DialogService.ShowErrorMessageBoxAsync(title, exception);
    }
