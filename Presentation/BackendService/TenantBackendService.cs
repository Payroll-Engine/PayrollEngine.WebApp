...
{
    public TenantBackendService(UserSession userSession, IConfiguration configuration) :
    ...
    protected override TenantService CreateService(IDictionary<string, object> parameters = null) =>
        new(HttpClient);
}