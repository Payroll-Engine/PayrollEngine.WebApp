...
public class CompanyCaseChangeValueBackendService : CaseChangeValueBackendService
{
    public CompanyCaseChangeValueBackendService(UserSession userSession, IConfiguration configuration) :
