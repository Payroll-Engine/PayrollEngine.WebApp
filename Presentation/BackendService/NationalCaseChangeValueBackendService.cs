...
public class NationalCaseChangeValueBackendService : CaseChangeValueBackendService
{
    public NationalCaseChangeValueBackendService(UserSession userSession, IConfiguration configuration) :
