...
public interface IUserNotificationService
{
    ...
    Task<bool> ShowMessageBoxAsync(string title, string message, string yesText = null,
    ...
    /// <param name="noText">The no button text</param>
    /// <param name="cancelText">The cancel button text</param>
    Task<bool> ShowMessageBoxAsync(string title, MarkupString message, string yesText = null,
        string noText = null, string cancelText = null);
    ...
    /// <param name="title">The dialog title</param>
    /// <param name="message">The message to show</param>
    Task<bool> ShowDeleteMessageBoxAsync(string title, string message);
    ...
    /// <param name="title">The dialog title</param>
    /// <param name="message">The message to show</param>
    Task<bool> ShowDeleteMessageBoxAsync(string title, MarkupString message);
    ...
    /// <param name="title">The dialog title</param>
    /// <param name="message">The message to show</param>
    Task ShowErrorMessageBoxAsync(string title, string message);
    ...
    /// <param name="title">The dialog title</param>
    /// <param name="message">The message to show</param>
    Task ShowErrorMessageBoxAsync(string title, MarkupString message);
    ...
    Task ShowErrorMessageBoxAsync(string title, Exception exception);
}