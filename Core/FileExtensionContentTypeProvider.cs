...
/// <remarks>extract from Microsoft.AspNetCore.StaticFiles.FileExtensionContentTypeProvider
/// see https://github.com/dotnet/aspnetcore/blob/fa239f20a52defa06029f6a316846d6e190e05bb/src/Middleware/StaticFiles/src/FileExtensionContentTypeProvider.cs</remarks>
/// </summary>
public class FileExtensionContentTypeProvider
{
    ...
    /// <summary>
    /// Given a MIME type, determine the file extension
    /// </summary>
    /// <param name="contentType">The resulting MIME type</param>
    /// <param name="extension">A file extension</param>
    /// <returns>True if file extension could be determined</returns>
    public bool TryGetExtension(string contentType, out string extension)
    {
        var key = Mappings.FirstOrDefault(x => string.Equals(contentType, x.Value)).Key;
        if (key == null)
        {
            extension = null;
            return false;
