...
public partial class PayrunParameterGrid : IDisposable
{
    ...
    private async Task CreatePayrunParameterAsync()
    {
        // payrun parameter create dialog
        var dialog = await (await DialogService.ShowAsync<PayrunParameterDialog>(
            Localizer.Item.CreateTitle(Localizer.PayrunParameter.PayrunParameter))).Result;
        ...
        try
        {
            ...
            if (result != null)
            {
                ...
                await UserNotification.ShowSuccessAsync(Localizer.Item.Created(payrunParameter.Name));
            }
        }
        catch (Exception exception)
        {
            ...
            await UserNotification.ShowErrorMessageBoxAsync(Localizer,
                Localizer.Item.CreateTitle(Localizer.PayrunParameter.PayrunParameter), exception);
        }
    }
    ...
    private async Task EditPayrunParameterAsync(PayrunParameter payrunParameter)
    {
        ...
        catch (Exception exception)
        {
            Log.Error(exception, exception.GetBaseMessage());
            await UserNotification.ShowErrorMessageBoxAsync(Localizer,
                Localizer.Item.EditTitle(Localizer.PayrunParameter.PayrunParameter), exception);
        }
    }
    ...
    private async Task DeletePayrunParameterAsync(PayrunParameter payrunParameter)
    {
        ...
        catch (Exception exception)
        {
            Log.Error(exception, exception.GetBaseMessage());
            await UserNotification.ShowErrorMessageBoxAsync(Localizer,
                Localizer.Item.DeleteTitle(Localizer.PayrunParameter.PayrunParameter), exception);
        }
    }
    ...
    private async Task SetupPayrunParameters()
    {
        ...
        catch (Exception exception)
        {
            Log.Error(exception, exception.GetBaseMessage());
            await UserNotification.ShowErrorMessageBoxAsync(Localizer, 
                Localizer.PayrunParameter.PayrunParameter, exception);
        }
    }
